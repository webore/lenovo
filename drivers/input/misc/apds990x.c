...
int APDS990x_PS_DETECTION_THRESHOLD = 600;
int APDS990x_PS_HSYTERESIS_THRESHOLD = 500;
        ...
        struct device_attribute *attr, const char *buf, size_t count)
{
    ...
    ret = apds990x_set_piht(client, val);
...
static DEVICE_ATTR(hwver, S_IWUSR | S_IRUGO, hw_get_version, NULL);
