...
dhd_custom_get_mac_address(unsigned char *buf)
{
	...
	uint len = 0;
	char wifimac[32] = {0};
	struct ether_addr ea_null= {{0x00, 0x12, 0xfe, 0x00, 0x00, 0x00}};
	...
	if(NULL == wifi_mac)
	{
		...
		rand_mac = random32();
		sprintf(wifimac,"00:12:fe:%02x:%02x:%02x", 
			(unsigned char)(rand_mac & 0x0F) | 0xF0, 
