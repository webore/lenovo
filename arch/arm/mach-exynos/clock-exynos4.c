...
static struct clksrc_clk exynos4_clkset_mipidphy4l = {
	.clk    = {
...
static struct clksrc_clk exynos4_clksrcs[] = {
	{
		...
		.clk		= {
			.name		= "sclk_mipi",
			.id		= -1,
			.parent		= &exynos4_clkset_mipidphy4l.clk,
			.enable		= exynos4_clksrc_mask_lcd0_ctrl,
			.ctrlbit	= (1 << 12),
		},
...
void __init_or_cpufreq exynos4_setup_clocks(void)
{
	...
	//jeff, set epll 400M for SDMMC, For test 4412_rev_2.0
	...
	/* jeff, support SDMMC 50M, 4412_rev_2.0 uses EPLL rather then MPLL */
	...
	/* jeff, support MSHC 50M, 4412_rev_2.0 uses EPLL rather then MPLL */
	...
	//jeff, if set epll 400M for SDMMC, disable epll for Audio. For test 4412_rev_2.0
	if(samsung_rev() < EXYNOS4412_REV_2_0)
	{
