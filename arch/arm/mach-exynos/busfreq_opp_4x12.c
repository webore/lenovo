...
#if defined(CONFIG_MACH_STUTTGART) /* jeff, stuttgart QoS table */
static unsigned int exynos4_qos_value[BUS_QOS_MAX][LV_END][6] = {
        {
                {0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                {0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                {0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                {0x06, 0x03, 0x06, 0x0e, 0x00, 0x00},
                {0x04, 0x03, 0x04, 0x0e, 0x00, 0x00},
                {0x03, 0x03, 0x03, 0x0e, 0x00, 0x00},
                {0x03, 0x0b, 0x00, 0x00, 0x00, 0x00},
        },
        {
                {0x06, 0x0b, 0x06, 0x0f, 0x00, 0x00},
                {0x06, 0x0b, 0x06, 0x0f, 0x00, 0x00},
                {0x06, 0x0b, 0x06, 0x0f, 0x00, 0x00},
                {0x06, 0x03, 0x06, 0x0e, 0x00, 0x00},
                {0x04, 0x03, 0x04, 0x0e, 0x00, 0x00},
...
#elif defined(CONFIG_BUSFREQ_QOS_1280X800) /* P4NOTE */
